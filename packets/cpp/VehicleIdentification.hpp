...
*/
#ifndef NGCP_VEHICLE_INDENTIFICATION_HPP
#define NGCP_VEHICLE_INDENTIFICATION_HPP
...
namespace ngcp {
  ...
  /**
    VehicleIdentification Template
  */
  class VehicleIdentification : INHERITS_ABSPACKET {
  public:

    VehicleIdentification(uint16_t id = 0, uint8_t type = 0)
...
#endif // NGCP_VEHICLE_INDENTIFICATION_HPP
